...
function whereami() {
    ...
    var options =
    {
        center: new kakao.maps.LatLng(36.335581, 127.448634),
        level: 3
    };
    map = new daum.maps.Map(container, options);

    var markerPosition = new kakao.maps.LatLng(36.335581, 127.448634);
...
function MakeMarker(lat, lng,stat) {
    ...
    if (stat == 3) {
        var imageSrc = 'C:\\Users\\kmh\\Desktop\\오픈소스 경진대회\\1002\bin\\Debug\\Marker_Image_Yellow.png',
        ...
        var imageSrc = 'C:\\Users\\kmh\\Desktop\\오픈소스 경진대회\\1002\bin\\Debug\\Marker_Image_Red.png',
            imageSize = new kakao.maps.Size(30, 45), // 마커이미지의 크기입니다
            imageOption = { offset: new kakao.maps.Point(27, 69) };
        ...
        var imageSrc = 'C:\\Users\\kmh\\Desktop\\오픈소스 경진대회\\1002\bin\\Debug\\Marker_Image_Blue.png',
            imageSize = new kakao.maps.Size(30, 45), // 마커이미지의 크기입니다
            imageOption = { offset: new kakao.maps.Point(27, 69) };
...
function ClickImage(marker) {
    if (selecteMarker == null) {
        ...
        var Image = new kakao.maps.MarkerImage(
            'C:\\Users\\kmh\\Desktop\\오픈소스 경진대회\\1002\bin\\Debug\\Marker_Image_Grean.png',
